...
saveFigures(datasets=c("BANKNOTE","CONCRETE","RED","WHITE"), sim_index=1, methods=c("IMIWAE","NIMIWAE","MIWAE","HIVAE","VAEAC","MEAN","MF","MICE"))
saveFigures(datasets=c("HEPMASS","POWER"), sim_index=1, methods=c("IMIWAE","NIMIWAE","MIWAE","HIVAE","VAEAC","MEAN","MICE"))   # huge datasets can't run MF b/c memory
